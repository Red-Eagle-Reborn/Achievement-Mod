...
var WoodGUI = android.graphics.BitmapFactory.decodeByteArray(android.util.Base64.decode(woodBase, 0), 0, android.util.Base64.decode(woodBase, 0).length);
var newGUI;
var wood = false;
...
function unlockAchievement(type) {
	var image;
	if(type=="wood") {
		image=new android.graphics.Bitmap.createBitmap(WoodGUI, 0, 0, 72, 72, matrix, true);
	}
